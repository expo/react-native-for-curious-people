...
export default class TinderExample extends Component {
  constructor(props) {
    super(props);
  ...
  componentWillMount() {
    this._panResponder = PanResponder.create({
      ...
      onPanResponderGrant: (e, gestureState) => {
        this.props.onStartInteraction && this.props.onStartInteraction();
      ...
      onPanResponderRelease: (e, {vx, vy}) => {
        this.props.onEndInteraction && this.props.onEndInteraction();
  ...
  render() {
    ...
    let rotate = pan.x.interpolate({inputRange: [-150, 0, 150], outputRange: ["-30deg", "0deg", "30deg"]});
